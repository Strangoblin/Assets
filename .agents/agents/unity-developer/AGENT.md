...
| **C7** | 知识优先 | 任何写代码的任务必须先加载知识库（`.agents/agents/unity-developer/references/`，2026-08-24 自 `Assets/MarkDowns/` 内化、归入本 agent），确保代码风格、命名、文件结构符合项目规范。 |
...
- **经验教训**：../../rules/shader-development.md、memory/2025-06-15-safety-lessons.md
